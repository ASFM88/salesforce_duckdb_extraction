...
CAMPOS_POR_TABELA = {
    "recordtype": ["id", "name", "description", "sobjecttype", "isactive"],
    "user": ["id", "name", "isactive", "title", "companyname", "email", "phone", "mobilephone", 
             "address", "createdbyid", "lastmodifiedbyid"],
    "account": ["id", "name", "raizdocumento__c", "creditoliberado__c", "valor_de_cr_dito_exposto__c", 
                ...
                "clientenegativado__c", "ownerid", "createdbyid", "lastmodifiedbyid"],
    "contact": ["id", "name", "accountid", "cpf__c", "phone", "email", "departamento__c", "createdbyid", "lastmodifiedbyid"],
    "cultura": ["id", "name", "cliente__c", "cultura__c", "hectare__c", 
                "dosagem__c", "potencial_de_consumo_ton__c", "createdbyid", "lastmodifiedbyid"],
    "culturacliente": ["id", "name", "cliente__c", "cultura__c", "lastmodifiedbyid"],
    "endereco": ["id", "conta__c", "name", "emailcontato__c", "emailparaenvionfe__c", 
                 ...
                 "statusintegracao__c", "createdbyid", "lastmodifiedbyid"],
    "cidade": ["id", "name", "codigo_ibge__c", "uf__c", "estado__c", "pais__c", 
               "sigla_do_estado__c", "codigo_externo__c", "createdbyid", "lastmodifiedbyid"],
    "subregiao": ["id", "name", "cidade__c", "status__c", "codigo_externo__c", "createdbyid", "lastmodifiedbyid"],
    "order": ["id", "numeropedido__c", "ordemvenda__c", "accountid", "endereco__c", "vendedores__c", 
              ...
              "gerencia__c", "territorio__c", "ownerid", "effectivedate", "createdbyid", "lastmodifiedbyid"],
    "orderitem": ["id", "orderid", "cultura__c", "top__c", "frete__c", "status__c", "statusproduto__c", 
                  ...
                  "quantidade__c", "createdbyid", "lastmodifiedbyid"],
    "vendedores": ["id", "name", "cnpjcpf__c", "tipo__c", "usuario__c", 
                   ...
                   "codigo_externo__c", "createdbyid", "lastmodifiedbyid"],
    "tabela_de_comissao": ["id", "name", "valor_de_desconto_de__c", "valor_de_desconto_ate__c", 
                           ...
                           "vendedores__c", "createdbyid", "lastmodifiedbyid"],
    ...
    "pagamento": ["id", "name", "cliente__c", "tipo_vencimento__c", "data_hora_recebimento__c", 
                  ...
                  "currencyisocode", "numero_unico_financeiro_adiantamento__c", "createdbyid", "pedido_de_venda__c", "lastmodifiedbyid"],
    "product2": ["id", "name", "productcode", "embalagem__c", "codigo_externo__c", "codigoembsap__c", 
                 ...
                 "premium__c", "recordtypeid", "createdbyid", "lastmodifiedbyid"],
    ...
    "top": ["id", "name", "status__c", "comentarios__c", "tipo_de_operacao__c", "frete__c", 
            ...
            "unidade_produtora__c", "cidade_entrega__c", "suframa__c", "createdbyid", "lastmodifiedbyid"],
    "previsao_entrega_produto": ["id", "name", "hedge__c", "valorhedge__c", "diashedge__c", 
                                 ...
                                 "valormes23__c", "valormes24__c", "lastmodifiedbyid"],
    ...
    "frete": ["id", "name", "data_vigor__c", "datafinal__c", "cidade_origem__c", "cidade_destino__c", 
              ...
              "valormes23__c", "valormes24__c", "createdbyid", "lastmodifiedbyid"]
}
